...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('transaction_ptr', models.OneToOneField(auto_created=True, on_delete=django.db.models.deletion.CASCADE, parent_link=True, primary_key=True, serialize=False, to='debits_base.Transaction')),
            ],
            bases=('debits_base.transaction',),
        ),
        migrations.CreateModel(
        ...
        migrations.AddField(
            model_name='purchase',
            name='item',
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='debits_base.Item'),
        ),
        migrations.AddField(
            model_name='purchase',
            name='old_subscription',
            field=models.ForeignKey(null=True, on_delete=django.db.models.deletion.CASCADE, related_name='new_subscription', to='debits_base.Purchase'),
        ),
        migrations.AddField(
            model_name='purchase',
            name='payment',
            field=models.OneToOneField(null=True, on_delete=django.db.models.deletion.CASCADE, to='debits_base.Payment'),
        ),
        migrations.AddField(
            model_name='payment',
            name='transaction',
            field=models.OneToOneField(on_delete=django.db.models.deletion.CASCADE, to='debits_base.Transaction'),
        ),
        migrations.AddField(
            model_name='item',
            name='product',
